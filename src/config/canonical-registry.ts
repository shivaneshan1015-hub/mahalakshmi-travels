...
export const canonicalRegistry: CanonicalContentRecord[] = [
  ...
  { id: 'art-04', contentType: 'guide', canonicalPath: '/travel-guide/how-to-plan-college-industrial-visit-trip', status: 'CONFIRMED', indexable: true, sitemapEligible: true, primaryIntent: 'College IV & Trip Planning Guide', owner: 'guide', redirectFrom: ['/travel-guide/college-industrial-visit-planning-guide'] },
  { id: 'art-05', contentType: 'guide', canonicalPath: '/travel-guide/weekend-getaways-from-madurai', status: 'CONFIRMED', indexable: true, sitemapEligible: true, primaryIntent: 'Weekend Getaways from Madurai Guide', owner: 'guide', redirectFrom: ['/travel-guide/temple-tour-etiquette-and-darshan-tips'] },
  { id: 'art-06', contentType: 'guide', canonicalPath: '/travel-guide/rameswaram-dhanushkodi-day-trip-guide', status: 'CONFIRMED', indexable: true, sitemapEligible: true, primaryIntent: 'Rameswaram & Dhanushkodi Day Trip Guide', owner: 'guide', redirectFrom: ['/travel-guide/choosing-between-van-and-sedan-for-group-travel'] },
  { id: 'art-07', contentType: 'guide', canonicalPath: '/travel-guide/madurai-to-kodaikanal-one-day-trip-plan', status: 'CONFIRMED', indexable: true, sitemapEligible: true, primaryIntent: 'Kodaikanal 1-Day Trip Plan Guide', owner: 'guide', redirectFrom: ['/travel-guide/rameshwaram-dhanushkodi-1-day-trip-guide'] },
  { id: 'art-08', contentType: 'guide', canonicalPath: '/travel-guide/madurai-to-tiruchendur-rameshwaram-temple-tour-guide', status: 'CONFIRMED', indexable: true, sitemapEligible: true, primaryIntent: 'Coastal Temple Tour Guide', owner: 'guide', redirectFrom: ['/travel-guide/south-india-hill-station-packing-checklist'] },
  { id: 'art-09', contentType: 'guide', canonicalPath: '/travel-guide/madurai-airport-ixm-outstation-cab-travel-guide', status: 'CONFIRMED', indexable: true, sitemapEligible: true, primaryIntent: 'Madurai Airport Outstation Travel Guide', owner: 'guide', redirectFrom: ['/travel-guide/monsoon-travel-tips-western-ghats'] },
  { id: 'art-10', contentType: 'guide', canonicalPath: '/travel-guide/wedding-guest-transportation-madurai-marriage-halls', status: 'CONFIRMED', indexable: true, sitemapEligible: true, primaryIntent: 'Wedding Guest Transport Guide', owner: 'guide', redirectFrom: ['/travel-guide/madurai-sightseeing-food-culture-guide'] },
];
