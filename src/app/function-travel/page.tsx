/**
 * MAHALAKSHMI TOUR & TRAVEL — FUNCTION & WEDDING TRAVEL ROUTE
 */
...
export const metadata: Metadata = constructMetadata({
  title: 'Wedding & Function Guest Transport in Madurai | Mahalakshmi Tour & Travel',
  description: 'Punctual 21-seater van and sedan car hire for marriage halls, guest transfers, and family functions in Madurai.',
  canonicalPath: '/function-travel',
});

export default function FunctionTravelPage() {
  const service = getTravelServiceBySlug('function-travel');

  if (!service) {
    notFound();
  }

  const { tours: relatedTours } = resolveServiceRelations('function-travel');
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Function Travel', itemUrl: 'https://mahalakshmitravels.com/function-travel', position: 3 },
  ]);
      ...
      <div className="container-editorial py-10 md:py-16">
        <BreadcrumbNav
          items={[
            ...
            { name: 'Function Travel', itemUrl: '/function-travel', position: 3 },
          ]}
          className="mb-8"
        />
