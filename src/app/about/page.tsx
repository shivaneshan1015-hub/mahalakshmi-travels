    ...
    <div className="container-editorial py-12 md:py-16">
      ...
      <div className="max-w-3xl mx-auto mb-16">
        ...
        <div className="space-y-6 type-body-large text-[var(--text-secondary)] leading-relaxed">
          ...
          <p>
            We operate our own dedicated fleet of vehicles—including our signature <strong>21-seater passenger van</strong> for group travel and <strong>sedan cars</strong> for families. By owning and maintaining our fleet directly, we ensure safety standards, spotless cleanliness, and local route coverage across South Indian highways.
          </p>
          <p id="madurai-origin">
